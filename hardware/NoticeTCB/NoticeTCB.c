// CPNR/hardware/NoticeTCB/NoticeTCB.c (1/3)
...
// CPNR/hardware/NoticeTCB/NoticeTCB.c (2/3)
...
// CPNR/hardware/NoticeTCB/NoticeTCB.c (3/3)
...
{
  unsigned long count = bcount * 256; // (1kbyte = 256 * 4 bytes)
...
// write deadtime ; ch : 0 = FADC, 1 = SADC_MUON, 2 = SADC_LS, 3 = MUON_DAQ
