// hardware/NoticeTCB/NoticeTCB.h
#ifndef TCB_H
#define TCB_H
...
#include <libusb.h> // libusb_context를 TCBopen에 전달하기 위해
...
extern void TCBwrite_TRIG_SWITCH_NKFADC500(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls, unsigned long muon_daq);
extern unsigned long TCBread_SWITCH_NKFADC500(int sid);
extern void TCBwrite_TRIG_SWITCH_M64ADC_MUON(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls,  unsigned long muon_daq);
extern unsigned long TCBread_SWITCH_M64ADC_MUON(int sid);
extern void TCBwrite_TRIG_SWITCH_M64ADC_LS(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls, unsigned long muon_daq);
extern unsigned long TCBread_SWITCH_M64ADC_LS(int sid);
extern void TCBwrite_TRIG_SWITCH_MUONDAQ(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls, unsigned long muon_daq);
