// hardware/ROOT_Wrappers/NoticeNKFADC500ROOT.h
...
public:
	...
	Int_t NKFADC500read_BCOUNT(int sid); // (int -> Int_t)
	...
	Int_t NKFADC500read_DATA(int sid, int bcount, unsigned char *data, unsigned int timeout); // (int -> Int_t)
